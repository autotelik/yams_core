  ...
  class PlaylistPresenter < YamsCore::Presenter
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-sm" aria-labelledby="dropdownMenuButton">
        #{view.link_to back_icon_tag('icon-pencil', text: I18n.t(:edit, scope: :global)), edit_playlist_path(playlist), { id: "edit-icon-#{model.class}-#{model.id}", class: 'dropdown-item' }  unless except_list.include? :edit}
